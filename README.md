...
- [Go](https://golang.org/doc/install) 1.25 or later (for development)
...
- `kosli_flow` - Create and manage flows that define CD pipeline templates with trails, artifacts, and attestations
