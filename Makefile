...
# Run acceptance tests for control list resource (terraform query, requires Terraform >= 1.14)
testacc-control-list: check-testacc-env
	@echo "Running acceptance tests for control list resource..."
	TF_ACC=1 $(GOTEST) -v ./internal/provider/... -run='TestAccControlListResource' -timeout 30m
...
# Run acceptance tests for flow resource
testacc-flow: check-testacc-env
...
# Run acceptance tests for service account API keys data source
testacc-service-account-api-keys-datasource: check-testacc-env
	@echo "Running acceptance tests for service account API keys data source..."
	TF_ACC=1 $(GOTEST) -v ./internal/provider/... -run='TestAccServiceAccountAPIKeysDataSource' -timeout 30m
...
help:
	...
	@echo "  testacc-control-list"
	@echo "                Run acceptance tests for control list resource (terraform query)"
	...
	@echo "  testacc-policy-attachment"
	@echo "                Run acceptance tests for policy_attachment resource"
	@echo ""
